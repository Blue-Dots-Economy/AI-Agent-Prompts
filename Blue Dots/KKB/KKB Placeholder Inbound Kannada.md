...
> *(NOT SPOKEN — SILENTLY calls get_profile with phoneNumber: ${contact_phone} → profile found: ಪ್ರಕಾಶ್, role ಎಲೆಕ್ಟ್ರಿಷಿಯನ್, location ಹುಬ್ಬಳ್ಳಿ, age + gender present. Nothing said about the fetch.)*
